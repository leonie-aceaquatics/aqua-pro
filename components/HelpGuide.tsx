  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'Red alarm boxes: Total Alkalinity 80 or below → add sodium bicarbonate now. Calcium Hardness below 90 → add calcium chloride now.', sub: [
        'They pop up a second or two after you finish typing the number, with roughly how many kg for that pool. Dose, then re-test before you leave and log the second test too.',
